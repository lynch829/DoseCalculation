...
for i=1:length(fluence)
        SourceX=beam_x(i);
        SourceY=beam_y(i);
        DetectorX=SourceX+ref_vector(1);
        DetectorY=SourceY+ref_vector(2);
        ...
        for j=1:length(l)
            ...
            index_x=floor(xx+1);
            index_y=floor(yy+1);
            fluence2(i)=fluence2(i)*exp(-l(i)*phantom(index_y,index_x));
            terma(index_y,index_x)=fluence2(i)+exp(-l(i)*phantom(index_y,index_x));
